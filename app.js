...
// Replace `\n` with actual newlines for private_key and save
const fixedServiceAccount = process.env.GOOGLE_APPLICATION_CREDENTIALS_JSON.replace(/\\n/g, '\n');
fs.writeFileSync(serviceAccountPath, fixedServiceAccount);

// Point Google SDK to the fixed file
